...
public class DateTimeExtensionTest
{
    ...
    public void TestDayStartReturnsMidnight()
    {
        ...
        // Assert
        Assert.Equal(new(2022, 1, 1, 0, 0, 0), dayStart1);
        ...
        // Assert
        Assert.Equal(dateTime2.Date, dayStart2);

        // Arrange
        var dateTime3 = new DateTime(2024, 2, 29, 12, 30, 0);
        var dayStart3 = dateTime3.DayStart();
        Assert.Equal(new(2024, 2, 29, 0, 0, 0), dayStart3);
    }
    ...
    public void TestTimeOverlap()
    {
        ...
        Assert.Equal(ETimeOverlap.完全重合, DateTimeExtension.TimeOverlap(sub0, validate0));
        ...
        Assert.Equal(ETimeOverlap.完全重合, DateTimeExtension.TimeOverlap(sub1, validate1));
        ...
        Assert.Equal(ETimeOverlap.完全重合, DateTimeExtension.TimeOverlap(sub2, validate2));
        ...
        Assert.Equal(ETimeOverlap.完全重合, DateTimeExtension.TimeOverlap(sub3, validate3));
        ...
        Assert.Equal(ETimeOverlap.完全不重合, DateTimeExtension.TimeOverlap(sub4, validate4));
        ...
        Assert.Equal(ETimeOverlap.后段重合, DateTimeExtension.TimeOverlap(sub5, validate5));
        ...
        Assert.Equal(ETimeOverlap.前段重合, DateTimeExtension.TimeOverlap(sub6, validate6));
    }
}