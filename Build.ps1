...
exec { & dotnet pack .\src\EasilyNET.PropertyInjection\EasilyNET.PropertyInjection.csproj -c Release -o $artifacts --include-symbols -p:SymbolPackageFormat=snupkg --no-build }
exec { & dotnet pack .\src\EasilyNET.PropertyInjection.AspNetCore\EasilyNET.PropertyInjection.AspNetCore.csproj -c Release -o $artifacts --include-symbols -p:SymbolPackageFormat=snupkg --no-build }
