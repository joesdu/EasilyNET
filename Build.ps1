...
exec { & dotnet pack .\src\EasilyNET.Mongo.GridFS.S3\EasilyNET.Mongo.GridFS.S3.csproj -c Release -o $ARTIFACTS --include-symbols -p:SymbolPackageFormat=snupkg --no-build }