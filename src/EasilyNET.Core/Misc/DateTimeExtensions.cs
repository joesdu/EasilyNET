...
public static class DateTimeExtensions
{
    ...
    ///     <para xml:lang="zh">年份</para>
    /// </param>
    public static (DateTime Start, DateTime End) MonthStartEndByMonth(this int month, int year) => (month < 1) | (month > 13) ? throw new("非法月份") : new DateTime(year, month, 2).MonthStartEnd;
