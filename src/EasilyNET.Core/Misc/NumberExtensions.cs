...
public static partial class NumberExtensions
{
    ...
    extension(double num)
    {
        ...
        ///     <para xml:lang="zh">四舍五入策略</para>
        /// </param>
        public decimal ToDecimal(int precision, MidpointRounding mode = MidpointRounding.AwayFromZero) => Math.Round((decimal)num, precision, mode);
        ...
        /// </summary>
        public string ToRmb() => ((decimal)num).ToRmb();
    }
    ...
    /// </typeparam>
    extension<T>(T a) where T : struct, IComparable, IConvertible, IFormattable
    {
        /// <summary>
        ...
        /// </param>
        public bool IsGreaterThan(T b, double epsilon = ModuleConstants.Epsilon)
        {
        ...
        ///     <para xml:lang="zh">精度默认: 0.000001</para>
        /// </param>
        public bool AreAlmostEqual(T b, double epsilon = ModuleConstants.Epsilon)
        {
            if (typeof(T) == typeof(float))
            {
                var floatA = a.ConvertTo<float>();
