...
/// </summary>
/// <typeparam name="TKey">标识类型</typeparam>
public abstract class AggregateRoot<TKey> : EntityBase<TKey>, IAggregateRoot<TKey> where TKey : IEquatable<TKey>;
...
public abstract class FullAggregateRoot<TKey, TUserKey> : AggregateRoot<TKey>, IHasSoftDelete, IHasCreateTime, IHasUpdatedTime, IHasCreateUserId<TUserKey>
