...
/// <inheritdoc />
internal sealed class PersistentConnOld : IDisposable
{
    private readonly AsyncLock _asyncLock = new();
    private readonly IConnectionFactory _connectionFactory;
    private readonly ILogger<PersistentConnOld> _logger;
    ...
    public PersistentConnOld(IConnectionFactory connFactory, IOptionsMonitor<RabbitConfig> options, ResiliencePipelineProvider<string> pp, ILogger<PersistentConnOld> logger)
    {
